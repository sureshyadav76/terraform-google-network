...
| <a name="input_description"></a> [description](#input\_description) | (Optional) An optional description of the network. The resource must be recreated to modify this field.Default is ''. | `string` | `""` | no |
...
| <a name="input_module_enabled"></a> [module\_enabled](#input\_module\_enabled) | A boolean flag to enable/disable network. | `bool` | `true` | no |
...
| <a name="input_name"></a> [name](#input\_name) | (Optional) The name of the network. The name will be used to prefix all associacted resources also. The name must be 1-63 characters long, and comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression "[a-z]([-a-z0-9]*[a-z0-9])?" which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash. Default is "main". | `string` | `""` | no |
| <a name="input_network_enabled"></a> [network\_enabled](#input\_network\_enabled) | A boolean flag to enable/disable network. | `bool` | `true` | no |
...
| <a name="output_network_id"></a> [network\_id](#output\_network\_id) | The outputs of the created network. |
<!-- END_TF_DOCS -->